...
AD_NAG_CONTENTS = [
    ...
    {
        "bg": "#d52b1e",
        "title": "🟡 СКАЧАЙ ЯНДЕКС БРАУЗЕР",
        "body": "Зачем ты сидишь в EBLAN Browser, когда есть Яндекс Браузер?\n"
                "С Алисой, Дзеном и защитой от EBLAN'а.\n\n"
                "Установи Яндекс Браузер прямо сейчас (или нет). 🟡",
        "btn": "Качаю Яндекс (нет)",
    },
    {
        "bg": "#0077ff",
        "title": "🔵 ВКОНТАКТЕ ЖДЁТ ТЕБЯ",
        "body": "У тебя 67 новых сообщений и 1488 лайков во ВКонтакте!\n"
...
class MainWindow(QMainWindow):
    ...
    CLICKBAIT = [
        ...
        ("WhatsApp 💬", "Раздаёт русским пользователям новые эмодзи! Чтобы получить нужно → читать далее"),
        ("Telegram ✈️", "Premium на 67 лет бесплатно для жителей РФ! Забрать → читать далее"),
        ("VK 🔵", "Тебе подарили 67 000 голосов от Павла Дурова. Получить → читать далее"),
        ("Сбер 🟢", "Вам одобрен кэшбэк 67%. Подтвердите карту → читать далее"),
        ("МАКС 📲", "Установи МАКС и получи 6700 ₽ на счёт мгновенно! → читать далее"),
        ("YouTube ▶️", "Разблокирован в РФ навсегда! Узнай как → читать далее"),
        ("WildBerries 📦", "Тебе пришла посылка которую ты не заказывал (67 000 ₽). Забрать → читать далее"),
        ("Apple 🍎", "iPhonE 67 Pro Max бесплатно первым 1488 россиянам! → читать далее"),
    ]
